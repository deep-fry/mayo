...
def main():
    ...
    for bitwidth in [2, 4, 8, 16]:
        command = './my datasets/{}.yaml models/override/{}.yaml models/override/quantize/shift_sparse.yaml trainers/cifarnet.yaml system.checkpoint.load={} system.info.plumbing=true {} eval info'.format(dataset, network, ckpt, extra_setup)
        subprocess.run(
