...
for percentage in [0.25, 0.5, 0.75, 1.0]:
    if percentage == 0.25:
        ...
        cmd = cmd_formatter.format(model, 'test', 10, gpus[0], gpus[1], percentage, percentage)
    elif percentage == 1.0:
